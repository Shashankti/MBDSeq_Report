...
knitr::include_graphics(c("Images/Annotate/IgG/DMR_prop/lower_level_tot.png","Images/Annotate/IgG/DMR_prop/upper_level_tot.png"))
...
knitr::include_graphics("Images/Annotate/Screenshot_20230723_161547.png")
```
...
```{r, echo=FALSE}
df <- data.table(fread("IgG_DMS_sequences.tsv"))
...
knitr::include_graphics(c("Images/Annotate/IgG/DMR_TAYN_with_dip/upper_level_tot.png","Images/Annotate/IgG/DMR_TAYN_with_dip/lower_level_tot.png"))
```
...
knitr::include_graphics(c("Images/Annotate/IgG/DMR_onlyDip/upper_level_tot.png","Images/Annotate/IgG/DMR_onlyDip/lower_level_tot.png"))
```
...
```{r, echo=FALSE, out.width="49%"}
knitr::include_graphics(c("Images/Annotate/IgG/MeDip/upper_level_tot.png","Images/Annotate/IgG/MeDip/lower_level_tot.png"))
```
...
```{r, echo=FALSE, out.width="49%"}
knitr::include_graphics(c("Images/Annotate/IgG/hMeDip/upper_level_tot.png", "Images/Annotate/IgG/hMeDip/lower_level_tot.png"))
...
```{r, echo=FALSE, out.width="49%"}
knitr::include_graphics(c("Images/Annotate/IgG/DipConsensus/upper_level_tot.png", "Images/Annotate/IgG/DipConsensus/lower_level_tot.png"))
